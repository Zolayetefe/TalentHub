...
export default function ApplicantDashboard() {
  ...
  // Helper function to safely extract job title from the new API response structure
  ...
  // Helper function to safely extract job ID for navigation
                      ...
                      <div className="flex justify-between items-start">
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-4 text-sm text-gray-600 mb-3">
                            ...
                            <span>•</span>
                            <span className="capitalize">{application.job?.jobType.replace("_", " ")}</span>
                            <span>•</span>
                            <span className="capitalize">{application.job?.jobSite}</span>
                          </div>
                    ...
                    <div key={application._id} className="border-b border-gray-200 p-6 hover:bg-gray-50">
                      <div className="flex justify-between items-start">
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-4 text-sm text-gray-500">
                            <span>Applied: {formatDate(application.createdAt)}</span>
                            <span>• Shortlisted: {formatDate(application.updatedAt)}</span>
                          </div>
                        </div>
                        <div className="flex items-center gap-3">
                          <span className={`px-3 py-1 rounded-full text-sm font-medium ${getStatusColor(application.status)}`}>
                    ...
                    <div key={application._id} className="border-b border-gray-200 p-6 hover:bg-gray-50">
                      <div className="flex justify-between items-start">
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-4 text-sm text-gray-500">
                            <span>Applied: {formatDate(application.createdAt)}</span>
                            <span>• Rejected: {formatDate(application.updatedAt)}</span>
                          </div>
                        </div>
                        <div className="flex items-center gap-3">
                          <span className={`px-3 py-1 rounded-full text-sm font-medium ${getStatusColor(application.status)}`}>
